...
namespace Convesys.Platform.Cryptography.Certificates.Backchannel.Validation
{
    ...
    public class BackchannelCertificateValidator : IBackchannelCertificateValidator
    {
        ...
        public bool Validate(object sender, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors)
        {
            ...
            this._logProvider.Log(SeverityLevel.Info, 0, String.Format("Validating backhannel certificate. sslPolicyErrors was: {0}", sslPolicyErrors), null, LoggerHelper.Formatter);
            ...
            {
                this._logProvider.Log(SeverityLevel.Info, 0, String.Format("Pinning validation entered. Validator type: {0}", configiration.BackchannelValidatorResolver.Type), null, LoggerHelper.Formatter);
