...
{
    public class CosmoStoreConfiguration : ICosmosDbConfiguration
    {
        ...
        public CosmoStoreConfiguration(IConnectionStringProvider<ICosmosDbConfiguration> cosmosConnectionResolver)
        {
