    ...
    public class Generator
    {
        public static void RunSync(char[] source)
        {
            ...
            try
            {
                ...
                {
                    for (int i1 = 1; i1 <= source.Length; i1++)
                    {
                        for (int i2 = 1; i2 <= source.Length; i2++)
                        {
                            for (int i3 = 1; i3 <= source.Length; i3++)
                            {
                                for (int i4 = 1; i4 <= source.Length; i4++)
                                {
                                    for (int i5 = 1; i5 <= source.Length; i5++)
                                    {
                                        for (int i6 = 1; i6 <= source.Length; i6++)
                                        {
                                            for (int i7 = 1; i7 <= source.Length; i7++)
                                            {
                                                for (int i8 = 1; i8 <= source.Length; i8++)
                                                {
                                                    try
                                                    {
                                                        var sb = new StringBuilder();
