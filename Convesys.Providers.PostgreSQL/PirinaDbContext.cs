...
namespace Pirina.Providers.EntityFramework
{
    ...
    public class PirinaDbContext : DbContext, IDbContext
    {
        private static readonly MethodInfo SetGlobalQueryMethod = typeof(PirinaDbContext)
            .GetMethods(BindingFlags.NonPublic | BindingFlags.Instance)
            .Single(t => t.IsGenericMethod && t.Name == "SetGlobalQuery");

        public PirinaDbContext(DbContextOptions<PirinaDbContext> options, IDbCustomConfiguration customConfiguration) 
            : base(options)
        {
        ...
        protected virtual void CreateModel(ModelBuilder modelBuilder)
        {
            ...
            if (CustomConfiguration.Seeders == null || CustomConfiguration.Seeders.Count == 0)
            {
                return;
            }
