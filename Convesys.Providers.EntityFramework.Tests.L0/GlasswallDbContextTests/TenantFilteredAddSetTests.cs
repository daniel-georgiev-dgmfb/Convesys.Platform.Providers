//  ----------------------------------------------------------------------- 
//   <copyright file="TenantFilteredAddSetTests.cs" company="Glasswall Solutions Ltd.">
...
namespace Pirina.Providers.EntityFramework.Tests.L1.GlasswallDbContextTests
{
    ...
    [TestFixture]
    public class TenantFilteredAddSetTests : DbTestBase
    {
        ...
        {
            ConfigurationMock.Setup(a => a.ModelKey).Returns("Key");
        ...
        public void TestSetUp()
        {
            ...
            using (var context = new PirinaDbContext(DbContextOptions, configurationMockObjectTenant1) as IDbContext)
            {
            ...
            using (var context = new PirinaDbContext(DbContextOptions, configurationMockObjectTenant2) as IDbContext)
            {
                context.Add(new TenantEntity());
                context.Add(new TenantEntity());
                context.SaveChanges();
